...
- **STEP 7: Download pretrained weights.**
    ...
    Download `drivetransformer_large.pth` from [Google Drive](https://drive.google.com/file/d/1wAXFWfjJm0cmP_pmgTkwxTUEs6Zu5j6i/view?usp=sharing) or [Baidu Cloud](https://pan.baidu.com/s/1ZunlLWRJXIblEG_L8rxRew?pwd=1234)
