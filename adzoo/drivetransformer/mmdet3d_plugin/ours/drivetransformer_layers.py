...
class SwiGLULayer(BaseModule):
    ...
    def forward(self, x, identity=None):
        ...
        if self.with_cp:
            return identity + self.postnorm(self.dropout(cp.checkpoint(self.swiglu, self.prenorm(x))))
        else:
            return identity + self.postnorm(self.dropout(self.swiglu(self.prenorm(x))))
